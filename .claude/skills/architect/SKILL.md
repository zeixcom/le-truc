...
name: architect
description: >
  Sparring partner for design and planning. Asks critical questions, researches feasibility,
  weighs tradeoffs, and produces or updates REQUIREMENTS.md, ARCHITECTURE.md, and TODO.md.
  Also triages GitHub issues and bug reports into actionable tasks.
user_invocable: true
---
...
For implementing tasks, use the `le-truc-dev`, `docs-server-dev`, `le-truc`, or `tech-writer` skill.
</scope>
