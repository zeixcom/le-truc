...
- Read `CLAUDE.md` — many apparent bugs are documented surprising behaviors
...
- Won't do: user has a specific explanation grounded in REQUIREMENTS.md or CLAUDE.md
