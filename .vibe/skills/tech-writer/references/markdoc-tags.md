...
Markdoc authoring reference for `docs-src/pages/`. Pages use Markdoc — a superset of Markdown with typed custom tags. Read this before editing any page in `docs-src/pages/`.
