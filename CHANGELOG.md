...
- **`@zeix/cause-effect` upgraded from `^1.0.0` to `^1.0.1`**: Documentation and JSDoc corrections across `Sensor`, `Memo`, `Store`, `List`, `Collection`, and utility types. No runtime behaviour changed.
