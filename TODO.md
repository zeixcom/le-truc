...
- [ ] LT-051: Reactive-lift analysis — lift lexical reads, hard-error on opaque call boundaries (CHECKLIST §2)
  **Skill:** le-truc-dev
...
- [ ] LT-052: Remove the `&{}` lazy-child sigil; plain `{}` carries reactivity (CHECKLIST §1)
  **Skill:** le-truc-dev
