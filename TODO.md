...
- [x] LT-125: Diagnose a ref-derived setup local that reaches the server render (LT-121 review finding) — do NOT widen the stub set. — done, pending review ⏳
  **Skill:** le-truc-dev
...
- [x] LT-129: TSRX039 fires on the sanctioned host-attribute OVERRIDE pattern (LT-118 finding). — done, pending review ⏳
  **Skill:** le-truc-dev
...
- [ ] LT-137: Rename `html={}` to `truc:html={}` and delete the phantom-upstream-keyword comments (LT-128 decision).
  **Skill:** le-truc-dev
