...
Defined in: [src/errors.ts:122](https://github.com/zeixcom/le-truc/blob/2877d2afe24fa5dcc6cc8851f03777f67a181664/src/errors.ts#L122)
...
Defined in: [src/errors.ts:128](https://github.com/zeixcom/le-truc/blob/2877d2afe24fa5dcc6cc8851f03777f67a181664/src/errors.ts#L128)
...
Host component passing the properties

##### target

`HTMLElement`

Target component the properties were passed to

##### reasons

`Map`\<`string`, `string`\>

Map of failing property name to the reason it could not be bound
