...
Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:67
...
> **new ReadonlySignalError**(`where`): `ReadonlySignalError`

Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:73
