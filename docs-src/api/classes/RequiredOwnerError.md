### Class: RequiredOwnerError

Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:78
...
> **new RequiredOwnerError**(`where`): `RequiredOwnerError`

Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:84
