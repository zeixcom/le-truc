### Class: UnsetSignalValueError

Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:35
...
> **new UnsetSignalValueError**(`where`): `UnsetSignalValueError`

Defined in: node\_modules/@zeix/cause-effect/types/src/errors.d.ts:41
