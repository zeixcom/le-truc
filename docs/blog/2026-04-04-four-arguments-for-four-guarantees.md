...
> **Updated April 7, 2026:** This section was updated after the post was first published. The design below reflects the current proposal, including the decision to make version 2.0 a breaking change. You can read the full discussion and see the earlier version in the [GitHub issue](https://github.com/zeixcom/le-truc/issues/34).
