 ...
 * `server/tsrx/compiler.ts` (`ComponentIR` is the seam), so `analysis/*`,
 ...
 * `server/tsrx/front-end.ts` (LT-202, ADR 0032 sub-design 6's anti-drift
 * contract).
 */

import { asArray, identifierName, isNode } from '../tsrx/ast-utils'
...
import type { RoutingSignal } from '../tsrx/tier'
