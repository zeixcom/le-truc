 ...
 * `server/tsrx/lower-shared.ts` (LT-202, ADR 0032 sub-design 6's anti-drift
...
import type { ExtractContext, ForIR, SignalIR, TemplateNode } from '../tsrx/ir'
import {
	type Lowering,
