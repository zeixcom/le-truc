 ...
 * registry entry. `server/tsrx/index.ts` (`compileComponent`) and
 * `server/tsrx-tsx/index.ts` (`compileComponentTsx`) are thin shells over
...
import { collectComposeElements } from './compiler'
