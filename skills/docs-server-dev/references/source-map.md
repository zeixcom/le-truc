...
| File | Contents |
|---|---|
| `server/build.ts` | Effect orchestration: initialises all 11 effects, awaits `ready` promises, HMR broadcast |
...
| `blogmeta.markdoc.ts` | Blog post metadata |
| `blogpost.markdoc.ts` | Blog post card |
