 ...
 */
declare const setAttribute: <P extends ComponentProps, E extends Element = HTMLElement>(name: string, reactive?: Reactive<string, P>) => Effect<P, E>;
/**
 ...
 */
declare const toggleAttribute: <P extends ComponentProps, E extends Element = HTMLElement>(name: string, reactive?: Reactive<boolean, P>) => Effect<P, E>;
