 ...
 */
declare const dangerouslySetInnerHTML: <P extends ComponentProps, U extends UI, E extends Element>(reactive: Reactive<string, P, E>, options?: DangerouslySetInnerHTMLOptions) => Effect<P, U, E>;
