 ...
 * `() => dangerouslyBindInnerHTML(reactive, opts)(host as any, element)`.
 * @since 0.11.0
 ...
 */
declare const dangerouslyBindInnerHTML: <P extends ComponentProps, E extends Element>(reactive: Reactive<string, P, E>, options?: DangerouslySetInnerHTMLOptions) => Effect<P, E>;
export { type DangerouslySetInnerHTMLOptions, dangerouslyBindInnerHTML };
