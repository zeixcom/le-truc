 ...
 */
declare const pass: <P extends ComponentProps, Q extends ComponentProps>(props: PassedProps<P, Q> | ((target: HTMLElement & Q) => PassedProps<P, Q>)) => Effect<P, HTMLElement & Q>;
