 ...
 */
declare const setProperty: <P extends ComponentProps, E extends Element, K extends keyof E & string>(key: K, reactive?: Reactive<E[K] & {}, P, E>) => Effect<P, E>;
/**
 ...
 *
 * @deprecated Use `run('prop', value => { el.hidden = !value })` in the v1.1 factory form instead.
 * @since 0.13.1
