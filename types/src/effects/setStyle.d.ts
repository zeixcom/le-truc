 ...
 */
declare const setStyle: <P extends ComponentProps, U extends UI, E extends HTMLElement | SVGElement | MathMLElement = HTMLElement>(prop: string, reactive?: Reactive<string, P, E>) => Effect<P, U, E>;
export { setStyle };
